...
/**
  ...
  *
  * Данная реализация вычисления чисел фибоначчи не птимална
  * Для того, что бы в этом убедиться Вы можете раскомменитировать
  * строчку с вычисленией 1000 -ого числа фибоначчи
  */
